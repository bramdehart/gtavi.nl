...
def generate_article(source_url: str, publication_date: str, generated_articles: list[dict] = []) -> dict:
    ...
    user_prompt = (
        ...
        "Plaats bovenaan een YAML-header (front matter) met de volgende velden:\n"
        "- title\n"
        f"- date (gebruik het formaat: yyyy-mm-dd hh:mm:ss -200, met als waarde: {publication_date})\n"
        "- categories\n"
        "- tags\n\n"
        ...
        "Begin het artikel met een markdown header (bijv. `# Titel van het artikel`).\n\n"
